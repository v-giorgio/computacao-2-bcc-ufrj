...
public class ContaTest {
    ...
    private ContaInvestimento contaInvestimentodoJoao;
    ...
    private long cpfDoFernando = 33333;
    private Correntista fernando;
    private ContaInvestimento contaInvestimentodoFernando;
    ...
    public void setUp() {
        ...
        contaInvestimentodoJoao = new ContaInvestimento(3, joao, "Poupança", (float) 0.02);

        maria = new Correntista("Maria", cpfDaMaria);
        contaDaMaria = new Conta(2, maria);
        maria.setContaCorrente(contaDaMaria);
        contaInvestimentodaMaria = new ContaInvestimento(4, maria, "CDB", (float) 0.025);

        fernando = new Correntista("Fernando", cpfDoFernando);
    ...
    public void testarTransferenciaSemFundos() {
        contaDoJoao.efetuarTransferencia(contaDaMaria, 100000);
...
//    }
    ...
    public void testarCriarContaInvestimento(){
        assertEquals("Conta de investimento criada com saldo inicial", 10, contaInvestimentodoJoao.getSaldoEmReais(), FLOAT_DELTA);
        assertEquals("Conta de investimento criada com saldo inicial", 10, contaInvestimentodaMaria.getSaldoEmReais(), FLOAT_DELTA);
    }

    @Test
    public void testarErroCriarContaInvestimento(){
        assertNull("Correntista não possui conta corrente", fernando.getContaCorrente());
        contaInvestimentodoFernando = new ContaInvestimento(5, fernando, "LCI", (float) 0.03);
        // forçando um erro: dará runtime exception, pois o correntista não possui conta corrente
    }

    @Test
    public void testarAplicarJuros(){
        contaInvestimentodoJoao.aplicarJuros();
        assertEquals("Juros aplicados", 10.2, contaInvestimentodoJoao.getSaldoEmReais(), FLOAT_DELTA);
        contaInvestimentodaMaria.aplicarJuros();
        assertEquals("Juros aplicados", 10.25, contaInvestimentodaMaria.getSaldoEmReais(), FLOAT_DELTA);

        assertEquals("Conta de investimento atualizada", 10.2, contaInvestimentodoJoao.getSaldoEmReais(), FLOAT_DELTA);
        assertEquals("Conta de investimento atualizada", 10.25, contaInvestimentodaMaria.getSaldoEmReais(), FLOAT_DELTA);
    }

    @Test
    public void testarResgatarInvestimentos(){

        assertEquals("Conta corrente com saldo default", 10, contaDoJoao.getSaldoEmReais(), FLOAT_DELTA);
        assertEquals("Conta corrente com saldo default", 10, contaDaMaria.getSaldoEmReais(), FLOAT_DELTA);

        assertEquals("Conta de investimentos com saldo default", 10, contaInvestimentodoJoao.getSaldoEmReais(), FLOAT_DELTA);
        assertEquals("Conta de investimentos com saldo default", 10, contaInvestimentodaMaria.getSaldoEmReais(), FLOAT_DELTA);

        contaInvestimentodoJoao.resgatarTotal(contaDoJoao);
        assertEquals("Conta de investimento zerada", 0, contaInvestimentodoJoao.getSaldoEmReais(), FLOAT_DELTA);
        assertEquals("Saldo atualizado na conta com o saldo de investimentos transferido", 20, contaDoJoao.getSaldoEmReais(), FLOAT_DELTA);
        contaInvestimentodaMaria.resgatarTotal(contaDaMaria);
        assertEquals("Conta de investimento zerada", 0, contaInvestimentodaMaria.getSaldoEmReais(), FLOAT_DELTA);
        assertEquals("Saldo atualizado na conta com o saldo de investimentos transferido", 20, contaDaMaria.getSaldoEmReais(), FLOAT_DELTA);
