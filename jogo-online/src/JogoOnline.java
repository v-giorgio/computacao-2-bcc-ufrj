...
//        Collections.sort(listaDeJogadores);  aqui Jogador teria que implementar a interface Comparable<Jogador>
    ...
    /**
     * Retorna uma lista dos jogadores ordenada por username
     * @return listaDeJogadores
     */
    public ArrayList<String> obterJogadoresEmOrdemAlfabetica(){
        ArrayList<String> listaDeJogadores = new ArrayList<>();
        listaDeJogadores.addAll(this.jogadorByUsername.keySet()); //retorna os usernames
        ComparadorDeJogadoresLexicografico ordenador = new ComparadorDeJogadoresLexicografico();
        listaDeJogadores = ordenador.compararUsernames(listaDeJogadores);
        return listaDeJogadores;
    }
